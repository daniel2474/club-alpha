...
@Entity
@Table(name="ca_tipo_actividad") //Se utiliza para poner el nombre real de la tabla en la base de datos
public class CATipoActividad {
	...
	public String toString() {
		return "TipoActividad [id=" + id + ", nombre=" + nombre + ", color=" + color + ", createdBy=" + createdBy
